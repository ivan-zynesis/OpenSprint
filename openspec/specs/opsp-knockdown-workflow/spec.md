# opsp-knockdown-workflow Specification

## Purpose

Define the `/opsp:knockdown` skill workflow that performs a bottom-up codebase analysis to extract surrogate architecture artifacts (architecture.md, ADRs, driver-specs, and DECISION-MAP.md) from an existing project by walking the file system, classifying files, compacting summaries, and applying reverse system design.
