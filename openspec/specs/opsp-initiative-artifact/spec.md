# OPSP Initiative Artifact Specification

## Purpose

Define the initiative descriptor artifact structure that stores initiative metadata, driver spec references, ADR references, and milestone plans.
