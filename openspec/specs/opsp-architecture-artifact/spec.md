# OPSP Architecture Artifact Specification

## Purpose

Define the architecture state document that compiles driver specs, ADRs, and decisions into a single-file architectural overview.
