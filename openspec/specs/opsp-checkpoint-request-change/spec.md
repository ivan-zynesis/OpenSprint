# Checkpoint Request Change Specification

## Purpose

Provide a change request action at review checkpoints during initiative execution, allowing operators to fork into a direct-propose or explore-first sub-path to make corrective changes before continuing.
