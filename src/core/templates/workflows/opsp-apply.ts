...
const OPSP_APPLY_INSTRUCTIONS = `Execute an initiative by orchestrating opsx cycles for each milestone, with git branch management and milestone review checkpoints.
