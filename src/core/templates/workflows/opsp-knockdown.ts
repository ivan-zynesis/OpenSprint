/**
 * OPSP Knockdown Workflow Template
 *
 * Reverse-engineer a surrogate (architecture.md, ADRs, driver-specs) from
 * an existing brownfield codebase using progressive compaction.
 */
import type { SkillTemplate, CommandTemplate } from '../types.js';

export function getOpspKnockdownSkillTemplate(): SkillTemplate {
  return {
    ...
    instructions: OPSP_KNOCKDOWN_INSTRUCTIONS,
    license: 'MIT',
...
export function getOpspKnockdownCommandTemplate(): CommandTemplate {
  return {
    name: 'OPSP: Knockdown',
    description: 'Knockdown — reverse-engineer surrogate artifacts from a brownfield codebase',
    category: 'Workflow',
    tags: ['workflow', 'opsp', 'knockdown', 'brownfield', 'architecture', 'reverse-engineering'],
    content: OPSP_KNOCKDOWN_INSTRUCTIONS,
  };
}

const OPSP_KNOCKDOWN_INSTRUCTIONS = `Reverse-engineer surrogate artifacts (architecture.md, ADRs, driver-specs) from an existing brownfield codebase.
